...
class TestCustomAtlasRegistration:
    ...
    def test_use_custom_atlas_in_analysis(self, custom_atlas_files, synthetic_lesion_data):
        """Test using a custom registered atlas in analysis."""
        atlas_path, labels_path = custom_atlas_files
        
        # Use the lesion from the fixture
        synthetic_lesion = synthetic_lesion_data
        ...
        try:
            ...
            analysis = AtlasAggregation(
                source="lesion_img",
                aggregation="mean",
                atlas_names=["CustomAnalysisAtlas"]
            )
