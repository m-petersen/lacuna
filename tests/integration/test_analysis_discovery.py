...
class TestAnalysisAutoDiscovery:
    ...
    def test_analysis_importable_by_name(self, clean_registry):
        ...
        for name in ["FunctionalNetworkMapping", "FocalDamage", "ParcelAggregation"]:
    ...
    def test_analysis_instantiation_after_discovery(self, clean_registry):
        ...
        # Get and instantiate FocalDamage (simplest one)
        FocalDamage = get_analysis("FocalDamage")
        instance = FocalDamage()
