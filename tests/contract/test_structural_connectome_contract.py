...
def test_register_structural_connectome_with_valid_files(tmp_path):
    ...
    from lacuna.assets.connectomes import register_structural_connectome, list_structural_connectomes
...
def test_register_structural_connectome_with_template(tmp_path):
    ...
    from lacuna.assets.connectomes import register_structural_connectome, load_structural_connectome
