...
def test_roi_result_initialization():
    """Test basic ROIResult initialization."""
    data = {
        "Schaefer400_1": 0.5,
        "Schaefer400_2": 0.3,
        "AAL_Frontal_L": 0.8
...
def test_tractogram_result_initialization_with_streamlines():
    ...
    streamlines = [
        ...
        np.random.rand(150, 3),
        np.random.rand(80, 3)
    ]
    
    result = TractogramResult(
        name="tract_streamlines",
...
def test_tractogram_result_get_data_from_file_not_implemented():
    ...
    with pytest.raises(NotImplementedError, match="Loading streamlines from file not yet implemented"):
