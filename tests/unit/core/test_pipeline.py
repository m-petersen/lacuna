...
class TestPipeline:
    ...
    def test_pipeline_chaining(self):
        ...
        pipeline = Pipeline(name="Chained").add(LocalDamage()).add(LocalDamage())
    ...
    def test_pipeline_describe(self):
        ...
        assert "LocalDamage" in description
...
class TestAnalyzeFunction:
    ...
    def test_analyze_batch_with_n_jobs(self, simple_subject):
        ...
        for r in results:
            assert "LocalDamage" in r.results
...
class TestAnalyzeStepsParameter:
    ...
    def test_analyze_steps_with_custom_params(self, simple_subject):
        ...
        result = analyze(
            simple_subject,
            steps={"LocalDamage": {"verbose": False}},
            verbose=False,
        )
    ...
    def test_analyze_multiple_steps(self, simple_subject):
        ...
        # Both LocalDamage steps should run (even if same analysis)
...
class TestAnalyzeLogLevel:
    ...
    def test_analyze_verbose_silent(self, simple_subject, capsys):
        ...
        analyze(simple_subject, steps={"LocalDamage": None}, verbose=False)
    ...
    def test_analyze_verbose_enabled(self, simple_subject):
        ...
        result = analyze(simple_subject, steps={"LocalDamage": None}, verbose=True)
    ...
    def test_analyze_verbose_is_default(self, simple_subject):
        ...
        # Should complete without error
        result = analyze(simple_subject, steps={"LocalDamage": None})
        assert result is not None
