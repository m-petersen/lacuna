...
class TestBatchOutputConsistency:
    ...
    def test_batch_results_same_as_sequential(self, batch_subjects):
        ...
        sequential_results = [
            analyze(s, steps={"LocalDamage": None}, verbose=False) for s in batch_subjects[:2]
        ]
    ...
    def test_empty_batch_returns_empty_list(self):
        ...
        results = analyze([], steps={"LocalDamage": None}, verbose=False)
...
class TestBatchErrorHandling:
    ...
    def test_single_invalid_type_in_batch_raises(self, batch_subjects):
        ...
        with pytest.raises(TypeError):
            analyze(mixed, steps={"LocalDamage": None}, verbose=False)
