...
Examples
--------
>>> from lacuna.atlas.registry import ATLAS_REGISTRY, list_atlases
>>>
...
ATLAS_REGISTRY: dict[str, AtlasMetadata] = {
    ...
    "TianSubcortex_3TS1": AtlasMetadata(
        ...
        space="MNI152NLin6Asym",
        resolution=1,
        description="Tian subcortical atlas at Scale 1 (coarsest, 3 Tesla dataset)",
    ...
    "TianSubcortex_3TS2": AtlasMetadata(
        ...
        space="MNI152NLin6Asym",
        resolution=1,
        description="Tian subcortical atlas at Scale 2 (medium, 3 Tesla dataset)",
    ...
    "TianSubcortex_3TS3": AtlasMetadata(
        ...
        space="MNI152NLin6Asym",
        resolution=1,
        description="Tian subcortical atlas at Scale 3 (finest, 3 Tesla dataset)",
    ...
    "HCP1065_thr0p1": AtlasMetadata(
        ...
        resolution=1,
        description="HCP-1065 probabilistic white matter tract atlas with 0.1 threshold",
        ...
        n_regions=None,  # Will be determined from labels file
    ),
}
