...
PARCELLATION_REGISTRY: dict[str, ParcellationMetadata] = {
    ...
    "Schaefer2018TianS1_400Parcels17Networks": ParcellationMetadata(
        ...
        space="MNI152NLin6Asym",
        resolution=1,
        description="Combined Schaefer 400 cortical (17 networks) + Tian Scale 1 subcortical parcellation",
    ...
    "Schaefer2018TianS2_400Parcels17Networks": ParcellationMetadata(
        ...
        space="MNI152NLin6Asym",
        resolution=1,
        description="Combined Schaefer 400 cortical (17 networks) + Tian Scale 2 subcortical parcellation",
    ...
    "Schaefer2018TianS3_400Parcels17Networks": ParcellationMetadata(
        ...
        space="MNI152NLin6Asym",
        resolution=1,
        description="Combined Schaefer 400 cortical (17 networks) + Tian Scale 3 subcortical parcellation",
