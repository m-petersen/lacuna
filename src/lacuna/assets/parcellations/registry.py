...
PARCELLATION_REGISTRY: dict[str, ParcellationMetadata] = {
    ...
    "schaefer2018parcels100networks7": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels100networks7_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels100networks7_dseg.txt",
    ...
    "schaefer2018parcels200networks7": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels200networks7_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels200networks7_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex, 28(9), 3095-3114",
        networks=[
            "Visual",
            "Somatomotor",
    ...
    "schaefer2018parcels400networks7": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels400networks7_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels400networks7_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex, 28(9), 3095-3114",
        networks=[
            "Visual",
            "Somatomotor",
    ...
    "schaefer2018parcels1000networks7": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels1000networks7_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels1000networks7_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex, 28(9), 3095-3114",
        networks=[
            "Visual",
            "Somatomotor",
    ...
    "tian2020parcels16": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Tian2020_desc-parcels16_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Tian2020_desc-parcels16_dseg.txt",
    ...
    "tian2020parcels32": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Tian2020_desc-parcels32_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Tian2020_desc-parcels32_dseg.txt",
        citation="Tian et al. (2020), Nature Neuroscience, 23(11), 1421-1432",
        n_regions=32,
    ),
    ...
    "tian2020parcels50": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Tian2020_desc-parcels50_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Tian2020_desc-parcels50_dseg.txt",
        citation="Tian et al. (2020), Nature Neuroscience, 23(11), 1421-1432",
        n_regions=50,
    ),
    ...
    "tian2020parcels54": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Tian2020_desc-parcels54_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Tian2020_desc-parcels54_dseg.txt",
        citation="Tian et al. (2020), Nature Neuroscience, 23(11), 1421-1432",
        n_regions=54,
    ),
    ...
    "schaefer2018parcels100networks17": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels100networks17_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels100networks17_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex, 28(9), 3095-3114",
        networks=[
            "VisCent",
            "VisPeri",
    ...
    "schaefer2018parcels200networks17": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels200networks17_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels200networks17_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex, 28(9), 3095-3114",
        networks=[
            "VisCent",
            "VisPeri",
    ...
    "schaefer2018parcels400networks17": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels400networks17_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels400networks17_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex, 28(9), 3095-3114",
        networks=[
            "VisCent",
            "VisPeri",
    ...
    "schaefer2018parcels1000networks17": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels1000networks17_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018_desc-parcels1000networks17_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex, 28(9), 3095-3114",
        networks=[
            "VisCent",
            "VisPeri",
    ...
    "schaefer2018tian2020parcels416networks17": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels416networks17_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels416networks17_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "VisCent",
            "VisPeri",
            "SomMotA",
    ...
    "schaefer2018tian2020parcels432networks17": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels432networks17_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels432networks17_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "VisCent",
            "VisPeri",
    ...
    "schaefer2018tian2020parcels450networks17": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels450networks17_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels450networks17_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "VisCent",
            "VisPeri",
    ...
    "schaefer2018tian2020parcels416networks7": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels416networks7_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels416networks7_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "Visual",
            "Somatomotor",
    ...
    "schaefer2018tian2020parcels432networks7": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels432networks7_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels432networks7_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "Visual",
            "Somatomotor",
    ...
    "schaefer2018tian2020parcels450networks7": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels450networks7_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels450networks7_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "Visual",
            "Somatomotor",
    ...
    "schaefer2018tian2020parcels454networks7": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels454networks7_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels454networks7_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "Visual",
            "Somatomotor",
    ...
    "schaefer2018tian2020parcels454networks17": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels454networks17_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels454networks17_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "VisCent",
            "VisPeri",
    ...
    "schaefer2018tian2020parcels1016networks17": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1016networks17_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1016networks17_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "VisCent",
            "VisPeri",
    ...
    "schaefer2018tian2020parcels1032networks17": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1032networks17_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1032networks17_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "VisCent",
            "VisPeri",
    ...
    "schaefer2018tian2020parcels1050networks17": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1050networks17_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1050networks17_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "VisCent",
            "VisPeri",
    ...
    "schaefer2018tian2020parcels1054networks17": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1054networks17_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1054networks17_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "VisCent",
            "VisPeri",
    ...
    "schaefer2018tian2020parcels1016networks7": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1016networks7_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1016networks7_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "Visual",
            "Somatomotor",
    ...
    "schaefer2018tian2020parcels1032networks7": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1032networks7_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1032networks7_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "Visual",
            "Somatomotor",
    ...
    "schaefer2018tian2020parcels1050networks7": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1050networks7_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1050networks7_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "Visual",
            "Somatomotor",
    ...
    "schaefer2018tian2020parcels1054networks7": ParcellationMetadata(
        ...
        parcellation_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1054networks7_dseg.nii.gz",
        labels_filename="tpl-MNI152NLin6Asym_res-01_atlas-Schaefer2018Tian2020_desc-parcels1054networks7_dseg.txt",
        citation="Schaefer et al. (2018), Cerebral Cortex; Tian et al. (2020), Nature Neuroscience",
        networks=[
            "Visual",
            "Somatomotor",
