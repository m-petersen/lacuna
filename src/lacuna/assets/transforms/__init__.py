...
This module provides transform registry and loading. The nonlinear warps are
generated by TemplateFlow and redistributed via OSF (downloaded and cached on first use).
"""
