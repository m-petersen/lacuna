...
class ConsoleLogger:
    ...
    def __init__(self, verbose: bool = True, width: int = 70, indent: str = "  "):
...
def log_section(title: str, width: int = 70) -> None:
    ...
    logger = ConsoleLogger(verbose=True, width=width)
...
def log_success(message: str, details: dict | None = None) -> None:
...
def log_progress(message: str, current: int | None = None, total: int | None = None) -> None:
