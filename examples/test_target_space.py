...
print("-"*70)
print(f"FunctionalNetworkMapping:")
...
print()
print(f"StructuralNetworkMapping:")
...
print(f"Running TestAnalysis (requires {TestAnalysis.TARGET_SPACE} @ {TestAnalysis.TARGET_RESOLUTION}mm)...")
try:
